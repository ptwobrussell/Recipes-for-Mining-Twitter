...
import twitter
from recipe__get_info import getInfoByScreenName
from recipe__oauth_login import oauth_login

def analyzeUsersInSearchResults(q, max_pages=15, results_per_page=100):
    ...
    screen_name_to_info = getInfoByScreenName(twitter_api, screen_name_to_tweet_ids.keys())
